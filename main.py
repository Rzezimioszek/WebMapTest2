        ...
        self.main_map = map.Map(
                    ...
                    layers=[
                        map.TileLayer(
                            ...
                            url_template="https://mapy.geoportal.gov.pl/wss/service/PZGIK/ORTO/WMTS/StandardResolution?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=ORTOFOTOMAPA&STYLE=default&FORMAT=image%2Fjpeg&TILEMATRIXSET=EPSG%3A2180&TILEMATRIX=EPSG%3A2180%3A11&TILEROW={x}&TILECOL={y}"
